...
create table "CONFIGURATION" ("ID" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"ID_USER" VARCHAR NOT NULL,"ID_INTEREST" VARCHAR NOT NULL,"CREATION_TIME" TIMESTAMP NOT NULL);
...
create table "PAGE_VISITED" ("ID" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"PAGE_NAME" VARCHAR NOT NULL,"IP" VARCHAR NOT NULL,"DATE" TIMESTAMP NOT NULL,"ID_USER" INTEGER);
...
create table "USER_INTEREST" ("ID" INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"ID_USER" INTEGER NOT NULL,"ID_INTEREST" INTEGER NOT NULL,"CREATION_TIME" TIMESTAMP NOT NULL);

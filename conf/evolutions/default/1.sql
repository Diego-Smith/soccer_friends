...
create table "CONFIGURATION" ("ID" BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,"KEY" VARCHAR NOT NULL,"VALUE" VARCHAR NOT NULL,"CREATION_TIME" TIMESTAMP NOT NULL);
create unique index "CONF_UNIQUE" on "CONFIGURATION" ("KEY");

...
create table "OAUTH2INFO" ("USER_ID" INTEGER NOT NULL PRIMARY KEY,"ACCESS_TOKEN" VARCHAR NOT NULL,"TOKEN_TYPE" VARCHAR,"EXIPIRES_IN" INTEGER,"REFRESH_TOKEN" VARCHAR);
...
alter table "OAUTH2INFO" add constraint "FK_USER_ID" foreign key("USER_ID") references "USER"("ID") on update NO ACTION on delete NO ACTION;
...
alter table "OAUTH2INFO" drop constraint "FK_USER_ID";

...
case class PageVisited(id: Option[Int] = None, pagename: String, ip: String, val dateVisited: Date =  new Date(Calendar.getInstance().getTimeInMillis()), fkUser: Option[Int] = None)
